...
public class ChessBoardRenderer {
    ...
    void drawPiece(Canvas canvas, Chess.ChessPiece piece, double minX, double minY, double width, double height) {
            ...
            switch(piece.getType()) {
                ...
                case BISHOP:
                    ...
                    break;
                case KNIGHT:
                    gc.fillRect(minX, minY + height * 0.5, width, height*0.4);
                    drawTriangle(gc, minX, minY + height * 0.1, width, height * 0.8);
                    break;
                case PAWN: 
    ...
    void drawAvailablePositions (Canvas canvas, PiecePosition[] piece) {
        GraphicsContext gc = canvas.getGraphicsContext2D();
        ...
        for (int i = 0; i < piece.length; i++) {
            ...
            gc.fillRect(minx, miny, width-0.1, height-0.1);        
        }                                    
    }
